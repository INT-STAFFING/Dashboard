...
function TimelinePanel({
  ...
  const stats: [string, string, string][] = [
    ...
    // I due indicatori BEF sono di portafoglio (tutte le annualità caricate),
    // non filtrati sull'anno selezionato come il resto del pannello: le righe
    // non ancora fatturate non portano una data su cui bucketizzarle. Il
    // sottotitolo lo dichiara per non lasciar leggere il valore come "del
    // periodo mostrato nel grafico".
    ['Fatturabile ad oggi', EUR2(befAggregates.fatturabile), 'BEF senza numero e data fattura · Intellera · tutti i periodi'],
    ['Fatturato emesso', EUR2(befAggregates.fatturatoEmesso), 'BEF con numero e data fattura · Intellera · tutti i periodi'],
  ];
